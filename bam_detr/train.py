...
from bam_detr.config import BaseOptions
from bam_detr.start_end_dataset import \
...
from bam_detr.inference import eval_epoch, start_inference, setup_model
...
def train(model, criterion, optimizer, lr_scheduler, train_dataset, val_dataset, opt):
    ...
    for epoch_i in trange(start_epoch, opt.n_epoch, desc="Epoch"):
        ...
        if opt.eval_path is not None and (epoch_i + 1) % eval_epoch_interval == 0:
            ...
            stop_score = metrics["brief"][opt.stop_metrics]
        ...
        save_interval = 10 if "subs_train" in opt.train_path else 500  # smaller for pretrain
